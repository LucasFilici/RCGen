...
class App(QMainWindow):
    ...
    def updateResult(self):
        ...
        constructive_feedback_dict.update({
            ...
            "PS 2: lateral rolls": " When performing " + gender1[gender] + " lateral rolls starting from a front float position, " + name + " should try to high five one hand with " + gender1[gender] + " other hand to help " + gender1[gender] + " flip onto " + gender1[gender] + " back, perform a starfish float, and repeat the same high five maneuver to get back onto " + gender1[gender] + " front",
